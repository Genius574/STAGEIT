...
users = User.create!([
  ...
  { email: "alice.brown@example.com", password: "password" },
  { email: "mike.wilson@example.com", password: "password" },
  { email: "sarah.davis@example.com", password: "password" },
  { email: "peter.parker@example.com", password: "password" },
  { email: "mary.jane@example.com", password: "password" },
  { email: "tom.hardy@example.com", password: "password" },
  { email: "emma.stone@example.com", password: "password" },
  { email: "chris.evans@example.com", password: "password" },
  { email: "lisa.kudrow@example.com", password: "password" },
  { email: "genius@gmail.com", password: "password" },
  { email: "jen.aniston@example.com", password: "password" },
  { email: "matt.leblanc@example.com", password: "password" },
  { email: "courtney.cox@example.com", password: "password" }
])
